...
for plainsub in subtitles_list:
  subfile = urllib2.urlopen("http://ais.channel4.com/subtitles/" + plainsub[3])
  path = "\\" + plainsub[0] + "\\" + 'Series ' + plainsub[1] + ' Episode ' + plainsub[2] + "\\"
  subfilename = 'Series ' + plainsub[1] + ' Episode ' + plainsub[2] + ' - ' + plainsub[4]
