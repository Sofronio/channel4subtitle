...
ass_output.append('Style: Default,Arial,32,&H00FFFFFF,&H0300FFFF,&H00000000,&H02000000,0,0,0,0,100,100,0,0,1,2,1,2,10,10,10,1')
ass_output.append('Style: white,Arial,32,&H00FFFFFF,&H0300FFFF,&H00000000,&H02000000,0,0,0,0,100,100,0,0,1,2,1,2,10,10,10,1')
ass_output.append('Style: yellow,Arial,32,&H0000FFFF,&H0300FFFF,&H00000000,&H02000000,0,0,0,0,100,100,0,0,1,2,1,2,10,10,10,1')
ass_output.append('Style: cyan,Arial,32,&H00FFFF00,&H0300FFFF,&H00000000,&H02000000,0,0,0,0,100,100,0,0,1,2,1,2,10,10,10,1')
ass_output.append('')
...
for i, lines in enumerate(subtitles_final):
  ass_output.append('Dialogue: 0,' + lines[0] + ',' + lines[1] + ',' + lines[2][1] + ',,0,0,0,,' + lines[3])
